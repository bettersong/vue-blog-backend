                ...
                <div class="widget green">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tbody>
                            <?php if(is_array($broken)): $i = 0; $__LIST__ = $broken;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="broken">
                                    <td class="ids"><?php echo ($item["id"]); ?></td>
                                    <td class="td_name"><?php echo ($item["name"]); ?></td>
                                    <td class="bigClass"  ><?php echo ($item["email"]); ?></td>
                                    <td class="smClass" ><?php echo ($item["content"]); ?></td>
        ...
        <script>
            $('.Delete').on('click',function(){
                ...
                layer.confirm('确认删除', {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/MyApp/blogBackend/Home/Broken/delete',
                        data: {
                            id: id,
                        },
                        dataType: 'json',
