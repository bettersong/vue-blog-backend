            ...
            <div class="widget-body">
                <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-large bigClass" type="text" value="前端开发" disabled />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">小类</label>
                        <div class="controls">
                            <input class="input-large smClass" type="text" value="<?php echo ($_GET['type']); ?>" disabled />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <!--<textarea class="input-xxlarge content" rows="3" style="height:200px;"></textarea>-->
                        </div>
                    </div>
                    <div class="form-actions">
                        <button class="btn btn-primary add">确定</button>
    ...
    $(function(){
        ...
        <script>
            $('.add').on('click',function () {
               ...
               //return;
                if(title == '' || content == ''){
                    layer.alert('所有项都不能为空！');
                    return
                }else {
                    $.ajax({
                        type: 'post',
                        url: '/MyApp/blogBackend/Home/FrontEnd/add',
                        data: {
                            title: title,
                            bigClass: bigClass,
                            smClass: smClass,
