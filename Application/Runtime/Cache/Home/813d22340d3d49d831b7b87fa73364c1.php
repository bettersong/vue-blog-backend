                ...
                <div class="widget green">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tbody>
                            <?php if(is_array($mood)): $i = 0; $__LIST__ = $mood;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="wenzhang">
                                    <td class="ids"><?php echo ($item["id"]); ?></td>
                                    <td class="td_name"><?php echo ($item["moodtag"]); ?></td>
                                    <td class="bigClass"  ><?php echo ($item["moodlogo"]); ?></td>
                                    <td class="smClass" ><?php echo ($item["moodcolor"]); ?></td>
                                    <td class="time" ><?php echo ($item["moodtime"]); ?></td>
                                    <td><?php echo ($item["moodcontent"]); ?></td>
...
<script>
    ...
    $(function(){
        ...
        <script src="/MyApp/blogBackend/Public/js/DT_bootstrap.js?11"></script>
        <script src="/MyApp/blogBackend/Public/js/jquery.scrollTo.min.js"></script>
        <script src="/MyApp/blogBackend/Public/js/editable-pManage.js"></script>
        <script>
            //删除操作
            var data = '<?php echo ($mood); ?>';
            console.log(data);
            $('.Delete').on('click',function(){
                ...
                layer.confirm('确定删除？', {
                    ...
                    $.ajax({
                        type: 'post',
                        url:'/MyApp/blogBackend/Home/MoodManage/delete',
                        data:{
                            id:id,
                        },
                        dataType:'json',
